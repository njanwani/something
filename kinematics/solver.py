...
def overall_imitation_error(
    ...
    return error, {"pose_error": pose_error, "ee_error": ee_error}
...
def imitate(
    ...
    def cost(x: np.ndarray):
        return overall_imitation_error(reference_sites, robot_chain, x, density, alpha)[
            0
        ]
...
if __name__ == "__main__":
    ...
    links = [[0, 0, 1], [0, 0, 1], [0, 0, 0.5], [0, 0, 0.5], [0, 0, 1]]
    axes = [[0, 1, 0], [0, 1, 0], [0, 0, 1], [0, 0, 1]]
