...
def wave():
    NJOINTS = (
        name2idx["left_wrist_yaw_joint"] - name2idx["left_shoulder_pitch_joint"] + 1
    )
...
def double_wave():
    ...
    po2D = PoseObserver2D(0.4, "accurate", "primitives/videos/doublewave.mp4")
    ret = True
    left_arm_traj = []
    right_arm_traj = []
    while ret:
...
def point():
    ...
    po2D = PoseObserver2D(0.4, "accurate", "primitives/videos/point.mp4")
